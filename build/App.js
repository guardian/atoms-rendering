...
var accessibility = require('@guardian/src-foundations/accessibility');
var types = require('@guardian/types');
var _$1 = require('@guardian/src-foundations/palette/');
var srcIcons = require('@guardian/src-icons');
var render = require('preact-render-to-string');
var YouTubePlayer = require('youtube-player');
var mq = require('@guardian/src-foundations/mq');
var srcButton = require('@guardian/src-button');
var srcRadio = require('@guardian/src-radio');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var render__default = /*#__PURE__*/_interopDefaultLegacy(render);
var YouTubePlayer__default = /*#__PURE__*/_interopDefaultLegacy(YouTubePlayer);
...
var Fragment$1 = jsxRuntime.Fragment;
...
var Container = (_ref) => {
  ...
  return jsx("div", {
    ...
    css: css(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n                padding-bottom: ", "px;\n                padding-left: ", "px;\n                padding-right: ", "px;\n                border-top: 1px solid ", ";\n                color: ", ";\n                background: ", ";\n\n                p {\n                    margin-top: ", "px;\n                    margin-bottom: ", "px;\n                }\n                i {\n                    font-style: italic;\n                }\n            "])), srcFoundations.space[1], srcFoundations.space[2], srcFoundations.space[2], palette.text.primary, palette.text.primary, palette.neutral[97], srcFoundations.space[3], srcFoundations.space[3]),
    children: children
  });
};
...
var pillarPalette = {
  [types.Pillar.News]: palette.news,
  [types.Pillar.Opinion]: palette.opinion,
  [types.Pillar.Sport]: palette.sport,
  [types.Pillar.Culture]: palette.culture,
  [types.Pillar.Lifestyle]: palette.lifestyle,
  [types.Special.Labs]: palette.lifestyle,
  [types.Special.SpecialReport]: palette.news
};
  ...
  return jsx("svg", {
    ...
    children: jsxs("g", {
      ...
      children: [jsx("circle", {
        ...
        fill: srcFoundations.palette.neutral[100]
      })]
    })
  });
};
...
var AudioAtom = (_ref3) => {
  ...
  var [isPlaying, setIsPlaying] = react.useState(false); // update current time and progress bar position

  var [currentTime, setCurrentTime] = react.useState(0);
  var [percentPlayed, setPercentPlayed] = react.useState(0); // url

  var [urlToUse, setUrlToUse] = react.useState(buildUrl(trackUrl, shouldUseAcast));
  react.useEffect(() => {
  ...
  var [durationTime, setDurationTime] = react.useState(0);
  react.useEffect(() => {
  ...
  var progressBarEl = react.useRef(null);
  react.useEffect(() => {
...
var Footer = (_ref) => {
  ...
  var [showThankYou, setShowThankYou] = react.useState(false);
  return jsxs("footer", {
    css: footerStyling,
    children: [jsx("div", {
      hidden: showThankYou,
...
var Summary = (_ref) => {
  ...
  var showHideStyling = css(_templateObject6$2 || (_templateObject6$2 = _taggedTemplateLiteral(["\n        background: ", ";\n        color: ", ";\n        height: 2rem;\n        position: absolute;\n        bottom: 0;\n        transform: translate(0, 50%);\n        padding: 0 15px 0 7px;\n        border-radius: 100em;\n        cursor: pointer;\n        display: inline-flex;\n        align-items: center;\n        border: 0;\n        margin: 0;\n        :hover {\n            background: ", ";\n        }\n    "])), _$1.neutral[7], _$1.neutral[100], pillarPalette[pillar][400]);
  var [hasBeenExpanded, setHasBeenExpanded] = react.useState(false);
  var [expandEventSent, setExpandEventFired] = react.useState(false);
  return jsxs("summary", {
    onClick: () => {
      if (!expandEventSent) {
        expandCallback();
    ...
    children: [jsx("span", {
      ...
      children: !hasBeenExpanded ? jsxs("span", {
        ...
        children: [jsx("span", {
          css: plusStyling,
          children: jsx(srcIcons.SvgPlus, {})
        }), "Show"]
      }) : jsxs("span", {
        css: iconSpacing,
        children: [jsx("span", {
          css: minusStyling,
          children: jsx(srcIcons.SvgMinus, {})
        }), "Hide"]
      })
    })]
  });
...
var Body$1 = (_ref) => {
  ...
  return jsxs("div", {
    children: [image && jsx("img", {
      ...
      css: creditStyling,
      children: [jsx(srcIcons.SvgInfo, {}), credit]
    })]
  });
};
...
var unifyPageContent = (_ref) => {
  ...
  return render__default['default'](jsxs("html", {
    children: [jsxs("head", {
      children: [jsx("meta", {
        charSet: "utf-8"
      }), jsx("meta", {
...
var getSizes = (role, isMainMedia) => {
  switch (role) {
    case 'inline':
      return "(min-width: ".concat(mq.breakpoints.phablet, "px) 620px, 100vw");

    case 'halfWidth':
      return "(min-width: ".concat(mq.breakpoints.phablet, "px) 300px, 50vw");
    ...
    case 'immersive':
      ...
      return isMainMedia ? "(orientation: portrait) 167vh, 100vw" : "(min-width: ".concat(mq.breakpoints.wide, "px) 1300px, 100vw");

    case 'supporting':
      return "(min-width: ".concat(mq.breakpoints.wide, "px) 380px, 300px");

    case 'showcase':
      return isMainMedia ? "(min-width: ".concat(mq.breakpoints.wide, "px) 1020px, (min-width: ").concat(mq.breakpoints.leftCol, "px) 940px, (min-width: ").concat(mq.breakpoints.tablet, "px) 700px, (min-width: ").concat(mq.breakpoints.phablet, "px) 660px, 100vw") : "(min-width: ".concat(mq.breakpoints.wide, "px) 860px, (min-width: ").concat(mq.breakpoints.leftCol, "px) 780px, (min-width: ").concat(mq.breakpoints.phablet, "px) 620px, 100vw");
  }
};
...
var YoutubeAtom = (_ref) => {
  ...
  var [hasUserLaunchedPlay, setHasUserLaunchedPlay] = react.useState(false);
  var player = react.useRef();
  react.useEffect(() => {
    if (!player.current) {
      player.current = YouTubePlayer__default['default']("youtube-video-".concat(assetId));
    }
...
var radioButtonWrapperStyles = css(_templateObject$b || (_templateObject$b = _taggedTemplateLiteral(["\n    label {\n        padding-top: ", "px;\n        padding-bottom: ", "px;\n        padding-left: ", "px;\n        padding-right: ", "px;\n\n        margin-bottom: ", "px;\n\n        background-color: ", ";\n\n        :hover {\n            background-color: ", ";\n        }\n        /* TODO: apply same styles on focus (requires source update) */\n\n        span {\n            ", ";\n        }\n    }\n"])), srcFoundations.space[3], srcFoundations.space[3], srcFoundations.space[2], srcFoundations.space[2], srcFoundations.space[2], palette.neutral[97], palette.neutral[86], typography.body.medium());
...
var AnswerWithSVG = (_ref) => {
  ...
  return jsxs("div", {
    css: css(_templateObject2$8 || (_templateObject2$8 = _taggedTemplateLiteral(["\n            display: flex;\n            flex-direction: row;\n\n            margin-bottom: ", "px;\n\n            padding-top: ", "px;\n            padding-bottom: ", "px;\n            padding-right: ", "px;\n            padding-left: ", "px;\n\n            background-color: ", ";\n        "])), srcFoundations.space[2], srcFoundations.space[3], srcFoundations.space[3], srcFoundations.space[4], srcFoundations.space[3], isCorrect ? palette.success[400] : palette.news[400]),
    children: [jsx("div", {
      css: css(_templateObject3$6 || (_templateObject3$6 = _taggedTemplateLiteral(["\n                margin-right: ", "px;\n\n                height: ", "px;\n                svg {\n                    fill: ", ";\n                    height: ", "px;\n                    width: ", "px;\n                }\n            "])), srcFoundations.space[1], srcFoundations.space[6], palette.neutral[100], srcFoundations.space[6], srcFoundations.space[6]),
      children: isCorrect ? jsx(srcIcons.SvgCheckmark, {}) : jsx(srcIcons.SvgCross, {})
    }), jsxs("label", {
      css: css(_templateObject4$5 || (_templateObject4$5 = _taggedTemplateLiteral(["\n                color: ", ";\n                display: flex;\n                flex-direction: column;\n\n                ", ";\n            "])), palette.neutral[100], typography.body.medium()),
      "data-testid": id,
...
var AnswerWithoutSVG = (_ref2) => {
  ...
  return jsx("div", {
    css: css(_templateObject7$2 || (_templateObject7$2 = _taggedTemplateLiteral(["\n            ", ";\n            background-color: ", ";\n\n            display: flex;\n            flex-direction: row;\n\n            margin-bottom: ", "px;\n\n            padding-top: ", "px;\n            padding-bottom: ", "px;\n            padding-right: ", "px;\n            padding-left: ", "px;\n        "])), typography.body.medium(), isCorrect ? palette.success[500] : palette.neutral[97], srcFoundations.space[2], srcFoundations.space[3], srcFoundations.space[3], srcFoundations.space[2], srcFoundations.space[9]),
    children: jsxs("label", {
...
var PersonalityQuizAtom = (_ref2) => {
  ...
  var [selectedGlobalAnswers, setSelectedGlobalAnswers] = react.useState({});
  var [hasSubmittedAnswers, setHasSubmittedAnswers] = react.useState(false);
  var [hasMissingAnswers, setHasMissingAnswers] = react.useState(false);
  var [topSelectedResult, setTopSelectedResult] = react.useState();
...
var PersonalityQuizAnswers = (_ref3) => {
  ...
  var [selectedAnswer, setSelectedAnswers] = react.useState();
  react.useEffect(() => {
...
var AnswersGroup = /*#__PURE__*/react.memo((_ref4) => {
  var {
    hasSubmittedAnswers,
    questionId,
    answers,
  ...
  return jsx("div", {
    css: [radioButtonWrapperStyles, css(_templateObject6$5 || (_templateObject6$5 = _taggedTemplateLiteral(["\n                    label {\n                        :hover {\n                            background-color: ", ";\n                        }\n                        /* TODO: apply same styles on focus (requires source update) */\n                    }\n                "])), hasSubmittedAnswers ? palette.neutral[97] : palette.neutral[86])],
    children: jsx(srcRadio.RadioGroup, {
      name: questionId,
      children: answers.map(answer => jsx(srcRadio.Radio, {
        value: answer.text,
        label: answer.text,
...
var Result = (_ref5) => {
  ...
  return jsxs("div", {
    ...
    }), sharingIcons && jsxs(react.Fragment, {
...
var KnowledgeQuizAtom = (_ref) => {
  ...
  var [quizSelection, setQuizSelection] = react.useState({});
...
var Question = (_ref2) => {
  ...
  var [selectedAnswerId, setSelectedAnswerId] = react.useState();
  var [hasSubmitted, setHasSubmitted] = react.useState(false);
  react.useEffect(() => {
...
var Snippet = css(_templateObject$e || (_templateObject$e = _taggedTemplateLiteral(["\n    :not(:last-child) {\n        border-left: 0.0625rem solid ", ";\n        padding-bottom: ", ";\n    }\n    padding-left: ", "px;\n    margin-left: ", "px;\n"])), srcFoundations.neutral[60], srcFoundations.remSpace[4], srcFoundations.space[4], srcFoundations.space[2]);
...
exports.ChartAtom = ChartAtom;
exports.ExplainerAtom = ExplainerAtom;
exports.GuideAtom = GuideAtom;
exports.InteractiveAtom = InteractiveAtom;
exports.KnowledgeQuizAtom = KnowledgeQuizAtom;
exports.PersonalityQuizAtom = PersonalityQuizAtom;
exports.ProfileAtom = ProfileAtom;
exports.QandaAtom = QandaAtom;
exports.TimelineAtom = TimelineAtom;
